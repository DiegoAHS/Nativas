    ...
    private void initCategory() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!items.isEmpty()){
                    binding.recyclerViewOffial.setLayoutManager(new LinearLayoutManager(MainActivity.this,LinearLayoutManager.HORIZONTAL,false));
                    binding.recyclerViewOffial.setAdapter(new CategoryAdapter(items));
                    binding.recyclerViewOffial.setNestedScrollingEnabled(true);
                }
